...
namespace Administrador {
    ...
    public partial class dsCategorias : global::System.Data.DataSet {
        ...
        public partial class categoriasDataTable : global::System.Data.TypedTableBase<categoriasRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public categoriasRow AddcategoriasRow(byte id, string nombre, string alias) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public categoriasRow FindByid(byte id) {
        ...
        public partial class categoriasRow : global::System.Data.DataRow {
            ...
            public byte id {
                get {
                    return ((byte)(this[this.tablecategorias.idColumn]));
                }
                set {
            ...
            public string alias {
                get {
                    try {
                        return ((string)(this[this.tablecategorias.aliasColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'alias\' de la tabla \'categorias\' es DBNull.", e);
                    }
                }
                set {
                    this[this.tablecategorias.aliasColumn] = value;
                }
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public bool IsaliasNull() {
                return this.IsNull(this.tablecategorias.aliasColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public void SetaliasNull() {
                this[this.tablecategorias.aliasColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Administrador.dsCategoriasTableAdapters {
    ...
    public partial class categoriasTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[categorias] WHERE (([id] = @Original_id) AND ([nombre] = @Orig" +
                "inal_nombre) AND ((@IsNull_alias = 1 AND [alias] IS NULL) OR ([alias] = @Origina" +
                "l_alias)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[categorias] ([nombre], [alias]) VALUES (@nombre, @alias);\r\nSEL" +
                "ECT id, nombre, alias FROM categorias WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[categorias] SET [nombre] = @nombre, [alias] = @alias WHERE (([id] = @Original_id) AND ([nombre] = @Original_nombre) AND ((@IsNull_alias = 1 AND [alias] IS NULL) OR ([alias] = @Original_alias)));
SELECT id, nombre, alias FROM categorias WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, nombre, alias FROM dbo.categorias";
        ...
        public virtual int Fill(dsCategorias.categoriasDataTable dataTable) {
        ...
        public virtual dsCategorias.categoriasDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            dsCategorias.categoriasDataTable dataTable = new dsCategorias.categoriasDataTable();
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(dsCategorias.categoriasDataTable dataTable) {
        ...
        public virtual int Delete(byte Original_id, string Original_nombre, string Original_alias) {
        ...
        public virtual int Insert(string nombre, string alias) {
            if ((nombre == null)) {
        ...
        public virtual int Update(string nombre, string alias, byte Original_id, string Original_nombre, string Original_alias, byte id) {
            if ((nombre == null)) {
                throw new global::System.ArgumentNullException("nombre");
            }
            else {
            ...
            if ((Original_alias == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Original_alias));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, string alias, byte Original_id, string Original_nombre, string Original_alias) {
            return this.Update(nombre, alias, Original_id, Original_nombre, Original_alias, Original_id);
        }
    }
