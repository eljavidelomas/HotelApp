...
namespace Administrador {
    ...
    public partial class dsCompras : global::System.Data.DataSet {
        ...
        public partial class comprasDataTable : global::System.Data.TypedTableBase<comprasRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public comprasRow AddcomprasRow(int compraId, int articuloId, string descripcion, System.DateTime fechaIngreso, string comentario, short compra, short reposicion, decimal precioUnitario) {
...
namespace Administrador.dsComprasTableAdapters {
    ...
    public partial class comprasTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[compras] WHERE (([compraId] = @Original_compraId) AND ([articuloId] = @Original_articuloId) AND ([descripcion] = @Original_descripcion) AND ([fechaIngreso] = @Original_fechaIngreso) AND ([comentario] = @Original_comentario) AND ([compra] = @Original_compra) AND ([reposicion] = @Original_reposicion) AND ((@IsNull_precioUnitario = 1 AND [precioUnitario] IS NULL) OR ([precioUnitario] = @Original_precioUnitario)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[compras] ([articuloId], [descripcion], [fechaIngreso], [comentario], [compra], [reposicion], [precioUnitario]) VALUES (@articuloId, @descripcion, @fechaIngreso, @comentario, @compra, @reposicion, @precioUnitario);
SELECT compraId, articuloId, descripcion, fechaIngreso, comentario, compra, reposicion, precioUnitario FROM compras WHERE (compraId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[compras] SET [articuloId] = @articuloId, [descripcion] = @descripcion, [fechaIngreso] = @fechaIngreso, [comentario] = @comentario, [compra] = @compra, [reposicion] = @reposicion, [precioUnitario] = @precioUnitario WHERE (([compraId] = @Original_compraId) AND ([articuloId] = @Original_articuloId) AND ([descripcion] = @Original_descripcion) AND ([fechaIngreso] = @Original_fechaIngreso) AND ([comentario] = @Original_comentario) AND ([compra] = @Original_compra) AND ([reposicion] = @Original_reposicion) AND ((@IsNull_precioUnitario = 1 AND [precioUnitario] IS NULL) OR ([precioUnitario] = @Original_precioUnitario)));
SELECT compraId, articuloId, descripcion, fechaIngreso, comentario, compra, reposicion, precioUnitario FROM compras WHERE (compraId = @compraId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT compraId, articuloId, descripcion, fechaIngreso, comentario, compra, repos" +
                "icion,precioUnitario FROM dbo.compras";
